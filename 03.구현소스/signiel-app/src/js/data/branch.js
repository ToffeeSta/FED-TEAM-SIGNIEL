...
export const branchData = {
    ...
    pusan: {
        name: "부산점",
        tit: "LOTTEHOTELS&RESORTS",
        cont: "편안하고 안락한 휴식형 객실,다양한 레스토랑과 화려한 연회시설, 비즈니스와 레저를 모두 만족시킬 수 있는 편의시설, 이 모두를 갖춘 멀티공간 롯데호텔이, 품격 높은 삶을 즐길 줄 아는 당신의 여유와 자긍심을 위해최상의 서비스로 충족시켜 드리겠습니다",
    },
    jeju: {
        name: "제주점",
