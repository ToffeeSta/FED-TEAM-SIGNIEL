      ...
      <div className="branch-container">
        ...
        <div className="branch-wrap">
          ...
          <div className="con-wrap">
            <div className="img-box">
              <img
                ...
                src={process.env.PUBLIC_URL+"/images/branch/" + local + "/main_01.png"}
                alt="메인01"
                title="메인01"
              />
            </div>
          ...
          <div className="con-wrap">
            <div className="img-box">
              <img
                src={process.env.PUBLIC_URL+"/images/branch/" + local + "/main_02.png"}
                alt="메인02"
                title="메인02"
              />
            </div>
            ...
            <div className="slide-box">
              ...
              <div>
                <div className="slide-img">
                  <img
                    src={process.env.PUBLIC_URL+"/images/branch/" + local + "/main_05_01.png"}
                    alt=""
                  />
                </div>
                <h2>{selData.tit04}</h2>
              ...
              <div>
                <div className="slide-img">
                  <img
                    src={process.env.PUBLIC_URL+"/images/branch/" + local + "/main_05_02.png"}
                    alt=""
                  />
                </div>
                <h2>{selData.tit05}</h2>
              ...
              <div>
                <div className="slide-img">
                  <img
                    src={process.env.PUBLIC_URL+"/images/branch/" + local + "/main_05_03.png"}
                    alt=""
                  />
                </div>
                <h2>{selData.tit06}</h2>
